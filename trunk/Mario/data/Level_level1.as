...
package 
{
	...
	public class Level_level1 extends BaseLevel
	{
		...
		[Embed(source="tiles.png")] public var Img_Group1Map1:Class;
		...
		{
			addSpriteToLayer(xxx, Group2Layer1Group , 156.000, 175.000, 0.000, false, onAddCallback );//"xx"
			addSpriteToLayer(xxx, Group2Layer1Group , 198.000, 175.000, 0.000, false, onAddCallback );//"xx"
			addSpriteToLayer(xxx, Group2Layer1Group , 237.000, 175.000, 0.000, false, onAddCallback );//"xx"
		}
